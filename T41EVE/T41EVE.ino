...
#if EVE_GEN > 4
#else
// Changed state so change screen static settings if possible
// Note some screens are handled elsewhere...
#if 1
	switch (radioState)
	{
		...
		case RadioState::SSB_IM3TEST_STATE:
			switch (lastState){
				...
				case RadioState::CW_CALIBRATE_STATE:
				case RadioState::RECEIVE_CALIBRATE_STATE:
					evedisplay.loadStaticScreenData(EVE_Display::Screens::transmitter);
					break;
				default:
					break;
			}
